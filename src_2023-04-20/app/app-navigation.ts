...
export const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: '재료비집계',
        path: '/mm/ptprodmattot'
      },
      {
        text: '제조원가처리',
        path: '/mm/prodmatcostprocess'
      },
      {
        text: '원가명세서',
        path: '/mm/coststatement'
      },
      {
        text: '원가현황조회',
        path: '/mm/coststatus'
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: '창고이동(내부)',
        path: 'inv/logicalWhMove'
      },
      {
        text: '창고이동(내부)승인',
        path: 'inv/logicalWhMoveConf'
      },
      {
        text: '창고이동(외부)',
        path: 'inv/logicalWhMoveOut'
      },
      {
        text: '창고이동(외부)승인',
        path: 'inv/logicalWhMoveOutConf'
      },
      {
        text: '재고조정확정',
