...
@Component({
  selector: 'app-invadjust-confirm',
  templateUrl: './invadjust-confirm.component.html',
  styleUrls: ['./invadjust-confirm.component.scss']
})
export class InvadjustConfirmComponent implements OnInit, AfterViewInit {
