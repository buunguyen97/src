...
import {RcvAcceptVO, RcvinstructService} from './rcvinstruct.service';
import {RcvExpectedVO} from '../rcvexpected/rcvexpected.service';
import {GridUtilService} from '../../../shared/services/grid-util.service';

@Component({
  selector: 'app-rcvinstruct',
  templateUrl: './rcvinstruct.component.html',
  styleUrls: ['./rcvinstruct.component.scss']
})
export class RcvinstructComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private service: RcvinstructService,
