...
import {PtProdMatCostService} from './pt-prod-mat-cost.service';
import {ActivatedRoute} from '@angular/router';

@Component({
  selector: 'app-pt-prod-mat-cost',
  templateUrl: './pt-prod-mat-cost.component.html',
  styleUrls: ['./pt-prod-mat-cost.component.scss']
})
export class PtProdMatCostComponent implements OnInit, AfterViewInit {
  ...
  constructor(public utilService: CommonUtilService,
              ...
              private service: PtProdMatCostService,
  ...
  async procProdMatCost(e): Promise<void> {
