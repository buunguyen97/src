...
import {SoacceptcancelService} from './soacceptcancel.service';
import {GridUtilService} from '../../../shared/services/grid-util.service';
import {SoCommonUtils} from '../soCommonUtils';
import {SoVO} from "../so/so.service";

@Component({
  selector: 'app-soacceptcancel',
  templateUrl: './soacceptcancel.component.html',
  styleUrls: ['./soacceptcancel.component.scss']
})
export class SoacceptcancelComponent implements OnInit, AfterViewInit {
  ...
  GRID_STATE_KEY = 'so_soacceptcancel';
  ...
  constructor(public utilService: CommonUtilService,
              ...
              private service: SoacceptcancelService
  ) {
  ...
  async onExcute(): Promise<void> {
    const msgStr = this.utilService.convert('so_soacceptcancel_title');
    const selectRowKeys = await this.mainGrid.selectedRowKeys;
