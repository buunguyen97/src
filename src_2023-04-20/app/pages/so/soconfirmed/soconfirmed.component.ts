...
import {SoconfirmedService} from './soconfirmed.service';
import {GridUtilService} from '../../../shared/services/grid-util.service';
import {SoCommonUtils} from '../soCommonUtils';
import {SoVO} from "../so/so.service";

@Component({
  selector: 'app-soconfirmed',
  templateUrl: './soconfirmed.component.html',
  styleUrls: ['./soconfirmed.component.scss']
})
export class SoconfirmedComponent implements OnInit, AfterViewInit {
  ...
  constructor(public utilService: CommonUtilService,
              ...
              private service: SoconfirmedService
  ) {
  ...
  async onExcute(): Promise<void> {
    const msgStr = this.utilService.convert('so_soconfirmed_title');
