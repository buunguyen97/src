...
import {Sabu060Service, Sabu060VO} from './sabu060.service';

@Component({
  selector: 'app-sabu060',
  templateUrl: './sabu060.component.html',
  styleUrls: ['./sabu060.component.scss']
})
export class Sabu060Component implements OnInit, AfterViewInit {

  constructor(public utilService: CommonUtilService,
              private service: Sabu060Service,
  ...
  @ViewChild('fromConsDate', {static: false}) fromConsDate: DxDateBoxComponent;
  @ViewChild('toConsDate', {static: false}) toConsDate: DxDateBoxComponent;
  ...
  mainFormData: Sabu060VO = {} as Sabu060VO;
  ...
  initForm(): void {
    ...
    this.fromConsDate.value = rangeDate.fromDate;
    this.toConsDate.value = rangeDate.toDate;
  }
  ...
  async onSearch(): Promise<void> {
    ...
    if (data.isValid) {
      this.mainFormData.fromConsDate = document.getElementsByName('fromConsDate').item(1).getAttribute('value');
      this.mainFormData.toConsDate = document.getElementsByName('toConsDate').item(1).getAttribute('value');
