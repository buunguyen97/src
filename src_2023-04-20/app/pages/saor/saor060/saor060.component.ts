...
import {Saor060Service, Saor060VO} from './saor060.service';

@Component({
  selector: 'app-saor060',
  templateUrl: './saor060.component.html',
  styleUrls: ['./saor060.component.scss']
})
export class Saor060Component implements OnInit, AfterViewInit {

  constructor(public utilService: CommonUtilService,
              private service: Saor060Service,
