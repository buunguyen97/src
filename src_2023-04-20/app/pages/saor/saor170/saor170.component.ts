...
import {Saor170Service, Saor170VO} from './saor170.service';

@Component({
    selector: 'app-saor170',
    templateUrl: './saor170.component.html',
    styleUrls: ['./saor170.component.scss']
})
export class Saor170Component implements OnInit, AfterViewInit {
    ...
    mainFormData: Saor170VO = {} as Saor170VO;
    ...
    constructor(public utilService: CommonUtilService,
                ...
                private service: Saor170Service,
    ...
    async onSearch(): Promise<void> {
        ...
        if (data.isValid) {
            ...
            this.searchData = this.mainFormData;
    ...
    onFocusedRowChanged(e, grid): void {
        ...
        if (e.row) {
            this.onSearchSub(e.row.data.itemcategory1id, this.searchData.fromOutDt, this.searchData.toOutDt);  // 상세조회
        }
    }

    // 조회
    async onSearchSub(itemcategory1id: string, fromOutDt: string, toOutDt: string): Promise<void> {
        if (itemcategory1id) {
            // Service의 get 함수 생성
