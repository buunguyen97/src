...
import {Saor150Service, Saor150VO} from './saor150.service';

@Component({
  selector: 'app-saor150',
  templateUrl: './saor150.component.html',
  styleUrls: ['./saor150.component.scss']
})
export class Saor150Component implements OnInit, AfterViewInit {

  constructor(public utilService: CommonUtilService,
              private service: Saor150Service,
  ...
  G_TENANT: any;
  mainFormData: Saor150VO = {} as Saor150VO;
