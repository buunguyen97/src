...
@Component({
  selector: 'app-saor031',
  templateUrl: './saor031.component.html',
  styleUrls: ['./saor031.component.scss']
})
export class Saor031Component implements OnInit, AfterViewInit {
  ...
  onSelectionChangedExptCd(e): void {
    ...
    if (this.popupMode === 'Add') {
      this.popupFormData.ptrn_cd = null; // 거래처(수출사)선택시 - 파트너사 초기화
