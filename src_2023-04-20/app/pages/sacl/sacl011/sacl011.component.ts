...
import {Sacl011Service, Sacl011VO} from './sacl011.service';

@Component({
  selector: 'app-sacl011',
  templateUrl: './sacl011.component.html',
  styleUrls: ['./sacl011.component.scss']
})
export class Sacl011Component implements OnInit, AfterViewInit {

  constructor(public utilService: CommonUtilService,
              private service: Sacl011Service,
  ...
  mainFormData: Sacl011VO = {} as Sacl011VO;
  ...
  initForm(): void {
    ...
    this.fromSoDate.value = firstDay;
    this.toSoDate.value = lastDay;
  ...
  async onSearch(): Promise<void> {
    ...
    if (data.isValid) {
      ...
      this.mainFormData.fromSoDate = document.getElementsByName('fromSoDate').item(1).getAttribute('value');
      this.mainFormData.toSoDate = document.getElementsByName('toSoDate').item(1).getAttribute('value');
  ...
  async onSave(): Promise<void> {
    try {
      ...
      const saveContent = this.saveData as Sacl011VO;
  ...
  setOutAmt(rowData: any, value: any): void {
