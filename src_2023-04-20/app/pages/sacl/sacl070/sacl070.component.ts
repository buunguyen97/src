...
import {Sacl070Service, Sacl070VO} from './sacl070.service';

@Component({
  selector: 'app-sacl070',
  templateUrl: './sacl070.component.html',
  styleUrls: ['./sacl070.component.scss']
})
export class Sacl070Component implements OnInit, AfterViewInit {
  ...
  constructor(public utilService: CommonUtilService,
              ...
              private service: Sacl070Service,
  ...
  mainFormData: Sacl070VO = {} as Sacl070VO;

  // grid
  mainDataSource: DataSource;
  mainEntityStore: ArrayStore;
  key = ['cal_date', 'cust_cd', 'item_cd'];
