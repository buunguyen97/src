...
import {Sacl012Service, Sacl012VO} from './sacl012.service';

@Component({
  selector: 'app-sacl012',
  templateUrl: './sacl012.component.html',
  styleUrls: ['./sacl012.component.scss']
})
export class Sacl012Component implements OnInit, AfterViewInit {

  constructor(public utilService: CommonUtilService,
              private service: Sacl012Service,
  ...
  mainFormData: Sacl012VO = {} as Sacl012VO;
  ...
  async onSave(): Promise<void> {
    try {
      ...
      const saveContent = this.saveData as Sacl012VO;
