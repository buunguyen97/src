...
import {Sacl010Service, Sacl010VO} from './sacl010.service';

@Component({
  selector: 'app-sacl010',
  templateUrl: './sacl010.component.html',
  styleUrls: ['./sacl010.component.scss']
})
export class Sacl010Component implements OnInit, AfterViewInit {

  constructor(public utilService: CommonUtilService,
              private service: Sacl010Service,
  ...
  mainFormData: Sacl010VO = {} as Sacl010VO;
  ...
  async onSave(): Promise<void> {
    try {
      ...
      const saveContent = this.saveData as Sacl010VO;
