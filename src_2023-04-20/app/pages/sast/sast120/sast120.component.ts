...
import {Sast120Service, Sast120VO} from './sast120.service';

@Component({
  selector: 'app-sast120',
  templateUrl: './sast120.component.html',
  styleUrls: ['./sast120.component.scss']
})

export class Sast120Component implements OnInit, AfterViewInit {

  constructor(public utilService: CommonUtilService,
              private service: Sast120Service,
  ...
  mainFormData: Sast120VO = {} as Sast120VO;
