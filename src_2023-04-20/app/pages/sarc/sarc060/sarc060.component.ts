...
import { Sarc060Service, Sarc060VO } from './sarc060.service';

@Component({
  selector: 'app-sarc060',
  templateUrl: './sarc060.component.html',
  styleUrls: ['./sarc060.component.scss']
})
export class Sarc060Component implements OnInit, AfterViewInit {

  constructor(public utilService: CommonUtilService,
              private service: Sarc060Service,
  ...
  mainFormData: Sarc060VO = {} as Sarc060VO;
  ...
  // 미회수량 표현식
  calcNoRtyQty(rowData): any {
    return rowData.out_qty - rowData.rtn_qty;
  }
}
